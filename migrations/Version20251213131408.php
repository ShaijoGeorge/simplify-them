 ...
 */
final class Version20251213131408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commission_rule ADD min_term INT DEFAULT NULL, ADD max_term INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commission_rule DROP min_term, DROP max_term');
