 ...
 */
final class Version20260107204258 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lic_plan DROP type');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lic_plan ADD type VARCHAR(50) NOT NULL');
