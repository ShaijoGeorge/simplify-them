...
#[UniqueEntity(fields: ['agencyCode'], message: 'This Agency Code is already registered.')]
#[UniqueEntity(fields: ['mobile'], message: 'This mobile number is already associated with another agency.')]
class Agency
{
